...
export default function Register1() {
  ...
  const handleSummit = (e) => {
    e.preventDefault();
    const { firstname, lastname, email, department, password } = formData;
  ...
  return (
    <>
      ...
      <section className="h-screen">
        <div className="h-full flex h-full flex-wrap items-center justify-center ">
          <div className="g-6  mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 content-evenly ">
